                ...
                <div className='text-white grid sm:grid-cols-3 xxs:grid-cols-2 grid-cols-1 gap-10 '>
                    <div className='xxs:justify-self-center'> 
                        ...
                        <ul className='mt-3'>
                            ...
                            <li className='text-[15px] font-medium pb-2 hover:text-white hover:underline text-gray-400'>
                                <Link href={window.route('group.savelist')}>Save List</Link>
                            </li>
                            <li className='text-[15px] font-medium pb-2 hover:text-white hover:underline text-gray-400'>
                    ...
                    <div className='xxs:justify-self-center'>
                        ...
                        <ul className='mt-3'>
                            <li>
                                <a href={group.group_setting.social_links['youtube']} className='flex group mb-2 items-center gap-2 text-gray-400 hover:text-white'>
                            ...
                            <li >
                                <a className='flex group mb-2 items-center gap-2 text-gray-400 hover:text-white' href={group.group_setting.social_links['facebook']}>
                            ...
                            <li >
                                <a href={group.group_setting.social_links['titok']} className='flex group mb-2 items-center gap-2 text-gray-400 hover:text-white'>
                                    ...
                                    <span className='text-[15px] font-medium   group-hover:underline text-gray-400'>Titok</span>
                                </a>
                            </li>
                            <li >
                                <a className='flex group mb-2 items-center gap-2 text-gray-400 hover:text-white' href={group.group_setting.social_links['telegram']}>
                                    ...
                                    <span className
                                        name='text-[15px] font-medium  group-hover:underline text-gray-400'>Telegram</span>
                                </a>
                            </li>
                        </ul>
                    </div>
