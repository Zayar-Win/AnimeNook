    ...
    return (
        <SectionContainer className='h-30 bg-[#0D0D0D] flex items-center justify-between'>
            ...
            <div className='flex items-center gap-3 p-2 max-w-[500px] min-w-[500px] rounded-md bg-[#212121]'>
                ...
                <input type="text" autoComplete='off' id='search' placeholder='Search Anime' className='bg-transparent text-white p-0 w-full h-full border-0 focus:ring-0 outline-none' />
            </div>
            <nav>
