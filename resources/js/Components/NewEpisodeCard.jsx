        ...
        <div className='flex items-center gap-4'>
            <div className='basis-[40%]'>
                <div className='w-[85%] translate-y-2 relative'>
                    <img className='w-full z-50 relative' src={episode?.chapterable?.background_image} alt="Anime Thumbnail" />
            ...
            <div className='basis-[60%] flex justify-between'>
                <div>
                    <h1 className='font-semibold'>{episode?.chapterable?.name}</h1>
                    <span className='text-gray-500 font-medium'>Episode {episode?.chapter_number}</span>
                    {
                ...
                <p className='self-end text-[rgb(41,189,181)] text-sm font-semibold'>{formateDate(episode?.created_at)}</p>
            </div>
        </div>
    )
}
