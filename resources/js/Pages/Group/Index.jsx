        ...
        <>
                                    ...
                                    <SwiperSlide key={i}  className='w-full h-full'>
                                        <div className='relative w-full h-full  overflow-hidden text-white'>
                                            ...
                                            <div className='relative z-20 pt-40 sm:pl-10 p-4 pb-12'>
                                                ...
                                                <p className='lg:w-[40%] sm:w-[70%] w-full mt-3 font-semibold'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Aspernatur, repudiandae quas nam pariatur ullam optio provident, esse at quam sunt eum voluptates nisi quis autem velit harum, voluptate hic voluptatem.</p>
                                            </div>
                                        </div>
                                    </SwiperSlide>
                                ))
                        ...
                        <div className='bg-[#0D0D0D] rounded-md flex self-stretch xl:flex-col flex-row flex-wrap  xl:gap-5 gap-14 px-6 py-12 text-white'>
                            {
                                newAnimes?.map((anime,i) => (
                                    <Link key={i} href={window.route('group.anime.detail',{anime})}>
                                        <div  className='flex items-center gap-3'>
                                            <div className='flex items-center gap-4'>
                                                <p className='font-bold xl:block hidden text-lg'>0{i+1}</p>
                                                <img className='sm:w-10 sm:h-16 h-28 w-20 object-cover' src={anime?.thumbnail} alt="" />
                                            </div>
            ...
            <SectionContainer>
                <div className='rounded-lg mb-20 mt-20 relative overflow-hidden px-5 py-8' style={{ background:'linear-gradient(90deg, rgba(203,177,48,0.6285364487591911) 0%, rgba(249,181,45,1) 42%)' }}>
                    ...
                    <img className='absolute w-[280px] sm:block hidden z-40 object-contain bottom-0 lg:right-40 right-24 h-[210px]' src={recommendedAnime?.transparent_background} alt="" />
                    <h1 className='sm:text-3xl text-xl font-extrabold uppercase'>Watch {recommendedAnime?.name}</h1>
            ...
            <SectionContainer>
                <div className='flex lg:p-0 p-10 items-center gap-8 bg-[#0D0D0D] rounded-md mt-8'>
                    <div className='basis-[40%] lg:flex  hidden items-center'>
                        <img className='xl:w-[60%] w-full object-cover h-full' src={recommendedAnime?.transparent_background} alt="" />
                    ...
                    <div className='lg:basis-[60%] w-full text-white'>
                        ...
                        <div className='flex items-center gap-1 my-3'>
                            <span className='text-[#40ecf8] sm:block hidden'>Series</span>
                            <svg className='sm:block hidden' xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24 24"><path fill="currentColor" d="M12 .5L16 8l7.5 4l-7.5 4l-4 7.5L8 16L.5 12L8 8l4-7.5Z"/></svg>
                            <div className='flex flex-wrap gap-x-3'>
                                {recommendedAnime?.tags.map((tag,i) => <Tag key={tag.id} className={`${(recommendedAnime?.tags.length ===1 && i === recommendedAnime.tags.length -1) ? 'border-left border-white' : '' } sm:px-3 !px-0`} text={tag.name} />)}
                            </div>
                        </div>
            ...
            <SectionContainer  padding={false} style={{ backgroundImage:'linear-gradient(55deg, rgba(223,136,28,1) 13%, rgba(249,198,45,1) 42%, rgba(216,119,23,1) 91%)' }}>
                <div className='sm:px-10 px-3 py-10'>
                    ...
                    <div className='flex lg:p-0 p-10 items-center gap-8 bg-[#0D0D0D] rounded-md'>
                        <div className='basis-[40%] lg:flex hidden items-center'>
                            <img className='xl:w-[60%] w-full object-cover h-[350px]' src={newAnimes[0]?.transparent_background} alt="" />
                        ...
                        <div className='lg:basis-[60%] w-full text-white'>
                            ...
                            <div className='flex items-center gap-1 my-3'>
                                <span className='text-[#40ecf8] sm:block hidden'>Series</span>
                                <svg xmlns="http://www.w3.org/2000/svg" className='sm:block hidden' width="10" height="10" viewBox="0 0 24 24"><path fill="currentColor" d="M12 .5L16 8l7.5 4l-7.5 4l-4 7.5L8 16L.5 12L8 8l4-7.5Z"/></svg>
                                <div className='flex items-center flex-wrap gap-x-3'>
                                    {newAnimes[0]?.tags.map((tag,i) => <Tag key={tag.id} className={`${(recommendedAnime?.tags.length ===1 && i === recommendedAnime.tags.length -1) ? 'border-left border-white' : '' } sm:px-3 !px-0`} text={tag.name} />)}
                                </div>
                            </div>
                            <p className='sm:w-[95%] w-full sm:text-base text-sm'>{newAnimes[0]?.description}</p>
                            <div className='mt-4 flex items-center flex-wrap sm:gap-8 gap-4'>
                    ...
                    <div className='flex lg:p-0 p-10 items-center gap-8 bg-[#0D0D0D] rounded-md mt-8'>
                        <div className='basis-[40%] lg:flex hidden items-center'>
                            <img className='xl:w-[60%] w-full object-cover h-[350px]' src={trendAnimes[0].transparent_background} alt="" />
                            <div className='w-[40%] xl:block hidden h-[320px]'>
                        ...
                        <div className='lg:basis-[60%] w-full text-white'>
                            ...
                            <div className='flex items-center gap-1 my-3'>
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" className='sm:block hidden' width="10" height="10" viewBox="0 0 24 24"><path fill="currentColor" d="M12 .5L16 8l7.5 4l-7.5 4l-4 7.5L8 16L.5 12L8 8l4-7.5Z"/></svg>
                                <div className='flex items-center flex-wrap gap-x-3'>
                                    {trendAnimes[0]?.tags.map((tag,i) => <Tag key={tag.id} className={`${(recommendedAnime?.tags.length ===1 && i === recommendedAnime.tags.length -1) ? 'border-left border-white' : '' } sm:px-3 px-0`} text={tag.name} />)}
                                </div>
                            </div>
                            <p className='sm:w-[95%] w-full sm:text-base text-sm'>{trendAnimes[0].description}</p>
                            <div className='mt-4 flex items-center flex-wrap sm:gap-8 gap-4'>
                                <Button className={'!bg-[#F47521] !px-8 rounded-none !gap-1'} text={'Start Watching S1 Ep1'} type={'button'} Icon={<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24"><path fill="currentColor" d="M8 19V5l11 7l-11 7Zm2-7Zm0 3.35L15.25 12L10 8.65v6.7Z"/></svg>} />
                                <Button outline text={'Add To WatchList'} className={'!px-8 rounded-none !gap-1 !border-[#F47521] text-[#F47521]'} type={'button'} Icon={<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24"><path fill="currentColor" d="M5 21V3h14v18l-7-3l-7 3Zm2-3.05l5-2.15l5 2.15V5H7v12.95ZM7 5h10H7Z"/></svg>} />
                            </div>
            ...
            <SectionContainer padding={false}>
                <div className='xxs:min-h-[50vh] min-h-[70vh]  relative mt-8 bg-fixed bg-no-repeat bg-cover bg-top' style={{ backgroundImage:'url(\'https://4kwallpapers.com/images/wallpapers/demon-slayer-1024x768-10716.jpg\')' }}>
                    <div className='absolute text-white flex items-center flex-col justify-center top-0 left-0 bottom-0 w-full h-full bg-[rgba(0,0,0,0.6)]'>
                        <h1 className='sm:text-4xl text-3xl font-bold text-center'>Signin Or Register Here</h1>
