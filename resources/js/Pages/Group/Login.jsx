      ...
      <div className='w-[80%] flex rounded-lg p-10 gap-8 bg-white'>
        <div className='basis-[60%]'>
          ...
          <form onSubmit={handleSubmit} className='mt-10 w-[70%]'>
            ...
            <span className='block  text-sm text-gray-700'>You don't have an account? <Link href={route('group.register')} className='text-blue-500 hover:underline font-semibold'>Register</Link> here.</span>
