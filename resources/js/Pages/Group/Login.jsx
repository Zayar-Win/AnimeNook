            ...
            <div className='w-[80%] flex rounded-lg p-10 gap-8 bg-white'>
                <div className='basis-[60%]'>
                    ...
                    <div className='border-l-4 border-l-yellow-400 rounded-md py-3 pl-4'>
                        ...
                        <p className='text-gray-700 font-medium w-[60%] pt-2'>Welcome back from the world of animes and movies Guy.Just Watch and Chill.</p>
                    </div>
                    <form onSubmit={handleSubmit} className='mt-10 w-[70%]'>
                        <div className={`relative ${errors.email ? 'shake' : ''}`}>
                ...
                <span className='absolute left-0 text-sm font-medium bottom-[-22px] text-red-500'>{errors.email}</span>
                        ...
                        <div className={`relative ${errors.password ? 'shake' : ''} mt-8`}>
                            ...
                            {
                                errors.password && 
                <span className='absolute left-0 text-sm font-medium bottom-[-22px] text-red-500'>{errors.password}</span>
                            }
                        </div>
                        <Button text={'Login'} type={'submit'} className={'bg-yellow-400 my-8 !px-20 inline-block'} />
                        <span className='block  text-sm text-gray-700'>You don't have an account? <Link href={window.route('group.register')} className='text-blue-500 hover:underline font-semibold'>Register</Link> here.</span>

                    </form>
                </div>
                <div className='basis-[40%]'>
                    <img className='w-full h-full object-cover' src="https://www.slashfilm.com/img/gallery/why-the-bleach-anime-ending-feels-so-anti-climactic/l-intro-1643214717.jpg" alt="" />
                </div>
            </div>
        </div>
    )
